...
export default function CardHortizontal ({ info }) {
  return (
    <Link to={`/bingewatching/people/${info.id}`} className='card mb-3 text-black' style={{ maxWidth: 400 }}>
      <div className='row g-2'>
        ...
        <div className='col-md-8'>
          <div className='card-body'>
            ...
            <h6 className='card-text'><small className='text-muted'>as {info.character}</small></h6>
          </div>
        </div>
      </div>
    </Link>
